...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to ARSAM Bank")
        p1 = PhotoImage(file='./images/bank22.png')
        window.iconphoto(True, p1)
        window.configure(background="red")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="yellow", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="lime", disabledforeground="#a3a3a3",
                                 foreground="black", borderwidth="0", highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0",
                                 text='''ADMIN \nLOGIN''')
        self.Button1.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Button1.place(relx=0.161, rely=0.583, height=38, width=87)

        self.Button2 = tk.Button(self.Canvas1, command=self.selectCustomer, activebackground="#ececec",
                                 activeforeground="#000000", background="red", disabledforeground="#a3a3a3",
                                 foreground="white", borderwidth="0", highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0",
                                 text='''CUSTOMER \nLOGIN''')
        self.Button2.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Button2.place(relx=0.617, rely=0.583, height=38, width=87)

        self.Label1 = tk.Label(self.Canvas1, background="black", disabledforeground="#a3a3a3",
...
class Error:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, background="red", borderwidth="1", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 9", foreground="white", highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0", text='''OK''', command=self.goback)
        self.Button1.place(relx=0.779, rely=0.598, height=24, width=67)

        global _img0
        _img0 = tk.PhotoImage(file="./images/error2.png")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global Canvas1
        Canvas1 = tk.Canvas(window, background="white", insertbackground="black", relief="ridge",
                            selectbackground="black", selectforeground="white")
        Canvas1.place(relx=0.108, rely=0.142, relheight=0.715, relwidth=0.798)

        self.Label1 = tk.Label(Canvas1, background="red", disabledforeground="white",
                               font="-family {Segoe UI} -size 14 -weight bold", foreground="white",
                               text="Admin Login")
        ...
        global _img1
        _img1 = tk.PhotoImage(file="./images/user.png")
        ...
        global _img2
        _img2 = tk.PhotoImage(file="./images/lock.png")
        ...
        global _img3
        _img3 = tk.PhotoImage(file="./images/bank22.png")
        self.Label5.configure(image=_img3)

        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="lime",
                                foreground="black",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="red",
                                     foreground="white",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        Label1 = tk.Label(Canvas1, background="red", disabledforeground="white",
                          font="-family {Segoe UI} -size 14 -weight bold", foreground="white",
                          text="Customer Login")
        ...
        global customer_img
        customer_img = tk.PhotoImage(file="./images/customer1.png")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#001c37", text="Select your option", background="cyan")
        ...
        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="red", borderwidth="0", disabledforeground="black",
                                 font="-family {Segoe UI} -size 11", foreground="white",
        ...
        self.Button2 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="lime", borderwidth="0", disabledforeground="black",
                                 font="-family {Segoe UI} -size 11", foreground="black",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
        ...
        self.Button3 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="red", borderwidth="0", disabledforeground="#a3a3a3",
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="lime", foreground="black", borderwidth="0",
                                 disabledforeground="black", font="-family {Segoe UI} -size 11",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", borderwidth="0",
                                 background="red", disabledforeground="#a3a3a3", foreground="#ffffff",
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="lime",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="black",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="red",
...
class createAdmin:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="lime",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="black",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text="Proceed",
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="red",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="#ffffff",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text="Back",
                                 command=self.back)
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#000000", text='''Select your option''', background="yellow")
        self.Labelframe1.place(relx=0.081, rely=0.081, relheight=0.415, relwidth=0.848)

        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ececec",
                                 activeforeground="#000000", background="lime", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="black",
...
class depositMoney:
    def __init__(self, window=None):
        ...
        p1 = PhotoImage(file='./images/deposit.png')
        window.iconphoto(True, p1)
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="lime",
                                 disabledforeground="#a3a3a3", borderwidth="0", foreground="black",
...
class withdrawMoney:
    def __init__(self, window=None):
        ...
        p1 = PhotoImage(file='./images/withdraw.png')
        window.iconphoto(True, p1)
        window.configure(borderwidth="2")
        window.configure(background="#f2f3f4")
...
class changePIN:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="lime",
                                 disabledforeground="#a3a3a3", foreground="black", borderwidth="0",
...
class checkAccountSummary:
    def __init__(self, window=None):
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="red", background="red",
                                 disabledforeground="#a3a3a3", foreground="#ffffff", borderwidth="0",
                                 highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0", text="Back", command=self.back)
        self.Button2.place(relx=0.214, rely=0.712, height=24, width=67)
